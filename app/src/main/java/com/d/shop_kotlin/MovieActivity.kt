...
//        get json
        doAsync {
//            val json = URL("http://www.json-generator.com/api/json/get/ceEQypuMGG?indent=2").readText()
...
//            object : TypeToken<List<Movie>>(){}.type)
    ...
    inner class MovieHolder(view: View):RecyclerView.ViewHolder(view){
        ...
        val postImage = view.movie_poster
